...
//         if (!g_TimeMs.CheckPrb)                 mbd_gateway_lite        	 
//         {                                               
...
//        if (!g_TimeMs.PollPrb)				   mbd_gateway_lite
//        {
//            g_TimeMs.PollPrb = 50;
//            UtilPollPrb ( );
//        }

//		if (!g_TimeMs.CheckMotorAccel )			   mbd_gateway_lite
//		{
...
//        if ((g_TimeMs.LampStart) && (g_TimeMs.LampStart < 100))		  mbd_gateway_lite
//        {
...
//			uiOneSecondCounts ++ ;											mbd_gateway_lite
...
//            SerSlcExtStatusPayload.BasicStatus.ucByte7 &= ~(SLC_STAT_B7_10_PERCENT_LAMP_LEFT |				   mbd_gateway_lite
